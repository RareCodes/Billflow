    ...
    <AppLayout>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="bg-white border border-[#E8E4F0] rounded-xl p-6">
          ...
          {/* Logo upload */}
          <div className="flex items-center gap-5 mb-5 pb-5 border-b border-[#E8E4F0]">
            <div
              className="w-20 h-20 rounded-xl border-2 border-dashed border-[#DDD6FE] flex items-center justify-center cursor-pointer hover:border-[#6D28D9] transition-colors overflow-hidden bg-[#F5F3FF]"
        ...
        {/* Brand Color */}
        <div className="bg-white border border-[#E8E4F0] rounded-xl p-6">
          <SectionHeader icon={Palette} title="Brand Color" desc="Used as the accent color on your invoices" />
          ...
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 rounded" style={{ background: form.brand_color }} />
            <span className="text-sm font-mono text-ink-secondary">{form.brand_color}</span>
            <span className="text-xs text-ink-muted">· Your invoices will use this color</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-[#E8E4F0] rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            {TEMPLATES.map(({ id, label, desc }) => (
              <button
                key={id}
                onClick={() => setForm({ ...form, invoice_template: id })}
              ...
              >
                ...
                <div className="w-full h-16 rounded-lg mb-3 overflow-hidden border border-[#E8E4F0]"
                    ...
                    <div className="p-2">
                      <div className="flex justify-between items-start mb-1.5">
                        ...
                        <div className="text-right">
                          <div className="h-1.5 w-10 rounded mb-0.5" style={{ background: form.brand_color }} />
                          <div className="h-1 w-6 rounded bg-gray-200 ml-auto" />
                        </div>
                      </div>
                      <div className="h-0.5 bg-gray-100 mb-1.5" />
                  ...
                  {id === 'bold' && (
                    <div className="flex h-full">
                      ...
                      <div className="flex-1 p-1.5">
                        ...
                        <div className="h-0.5 w-4/5 rounded bg-gray-100 mb-1.5" />
                        <div className="h-0.5 w-full rounded bg-gray-100 mb-0.5" />
                  ...
                  {id === 'minimal' && (
                    <div className="p-2.5">
                      ...
                      <div className="h-px bg-gray-800 mb-1.5" />
                      <div className="space-y-0.5">
                        <div className="h-1 w-full rounded bg-gray-100" />
                ...
                {form.invoice_template === id && (
                  <div className="flex items-center gap-1 mt-2">
                    <Check size={11} style={{ color: '#6D28D9' }} />
                    <span className="text-xs font-semibold" style={{ color: '#6D28D9' }}>Selected</span>
                  </div>
                )}
              </button>
            ))}
        ...
        <div className="bg-white border border-[#E8E4F0] rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea value={form.default_notes} onChange={e => setForm({ ...form, default_notes: e.target.value })} placeholder="Payment is due within 14 days. Thank you for your business." rows={3} className="w-full px-3 py-2 text-sm border border-[#E8E4F0] rounded-lg outline-none focus:border-[#6D28D9] transition-all resize-none" />
            </div>
          </div>
        </div>
