...
function MiniBarChart({ data, brandColor }) {
        ...
        <div key={i} className="flex-1 flex flex-col items-center gap-1">
          <div
            ...
            style={{
              ...
              background: d.isCurrentMonth ? brandColor : brandColor + '30',
            }}
          />
...
function OnboardingStep({ done, label, description, onClick, brandColor }) {
  return (
    <div
      onClick={!done ? onClick : undefined}
      className={`flex items-start gap-3 p-3 rounded-lg transition-all ${
        done ? 'opacity-60' : 'cursor-pointer group'
      }`}
      style={{ background: 'transparent' }}
      onMouseEnter={e => !done && (e.currentTarget.style.background = brandColor + '08')}
    ...
    >
      ...
      {!done && (
        <ArrowRight size={14} className="text-ink-muted shrink-0 mt-1" />
      )}
    </div>
  )
}
...
export default function Dashboard() {
  ...
  const fmt = (n) => {
    const sym = { NGN: '₦', USD: '$', GBP: '£', EUR: '€', CAD: 'CA$' }[profile?.default_currency || 'NGN'] || '₦'
    return `${sym}${Number(n).toLocaleString('en-NG', { minimumFractionDigits: 2 })}`
  }
  ...
  return (
    <AppLayout>
      ...
      {showOnboarding && (
        <div className="bg-white border rounded-xl p-5 mb-6 relative overflow-hidden"
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <button onClick={dismissOnboarding} className="text-xs text-ink-muted hover:text-ink transition-colors">
              Dismiss
            </button>
          </div>
          ...
          <div className="space-y-1">
            {onboardingSteps.map((step, i) => (
              <OnboardingStep key={i} {...step} brandColor={brandColor} />
            ))}
          </div>
        </div>
      )}
      ...
      {allDone && !dismissedOnboarding && (
        <div className="bg-green-50 border border-green-200 rounded-xl px-5 py-4 mb-6 flex items-center gap-4">
          ...
          <button onClick={dismissOnboarding}
            className="text-xs text-green-600 hover:text-green-800 font-medium transition-colors shrink-0">
            Got it
          </button>
        </div>
      )}
      ...
      {isNewUser ? (
        ...
        <div className="space-y-6">
          <div className="bg-white border border-[#E8E4F0] rounded-xl p-8 text-center">
            ...
            <h2 className="font-bold text-ink text-base mb-1" style={{ fontFamily: 'Outfit, sans-serif' }}>
        ...
        <div className="space-y-6">
          ...
          {/* Stats strip */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-px rounded-xl overflow-hidden border border-[#E8E4F0]"
            ...
            {[
              ...
              <div key={label} className="bg-white px-4 py-4 flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-base font-bold text-ink mt-0.5 truncate"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white border border-[#E8E4F0] rounded-xl p-6">
              ...
              <MiniBarChart data={monthlyData} brandColor={brandColor} />
              ...
              <div className="space-y-2">
                {[
                  ...
                  <button key={label} onClick={() => navigate(path)}
                    ...
                    style={{ background: primary ? brandColor + '15' : 'transparent' }}
                    onMouseEnter={e => !primary && (e.currentTarget.style.background = brandColor + '08')}
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs font-semibold"
                        style={{ color: primary ? brandColor : '#0F1117' }}>{label}</p>
            ...
            {recentInvoices.map((inv) => (
              <div key={inv.id} onClick={() => navigate(`/invoices/${inv.id}`)}
                ...
                <div className="hidden md:grid grid-cols-12 items-center">
                  ...
                  <p className="col-span-2 text-xs font-semibold text-ink"
                    style={{ fontFamily: 'IBM Plex Mono, monospace' }}>{inv.invoice_number}</p>
                  ...
                  <p className="col-span-2 text-xs font-bold text-ink text-right"
